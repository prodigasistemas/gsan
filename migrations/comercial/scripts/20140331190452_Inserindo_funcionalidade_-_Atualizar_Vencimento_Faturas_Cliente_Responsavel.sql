...
VALUES (16008,7,'Atualizar Vencimento de Fatura de Cliente Responsavel',now(),
...
VALUES (15020, 16008, 'Atualizar Vencimento de Fatura de Cliente Responsavel', 'AtVeFaCl', 'atualizarVencimentoFaturaClienteResponsavelAction.do',now(), null, null, 3, 
        null, 2);

INSERT INTO seguranca.grupo_func_operacao(grup_id, oper_id, fncd_id, gfop_tmultimaalteracao)
VALUES (1, 15020, 16008, now());
