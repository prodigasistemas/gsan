...
VALUES (nextval('seguranca.seq_funcionalidade'),9,'Gerar Resumo Creditos Avisos Bancarios',now(),'/Gsan/Relatorios/Arrecadacao','exibirGerarRelatorioResumoCreditosAvisosBancarios.do' ,1,'GeReCrAvBa',1,2,2,106);
...
VALUES ((nextval('seguranca.seq_operacao')), currval('seguranca.seq_funcionalidade'), 'Gerar Resumo Creditos Avisos Bancarios', 'GeReCrAvBa', 'gerarRelatorioResumoCreditosAvisosBancariosAction.do',now(),null,null,14,null,2);
