...
**/
public class ExibirConsultarDadosDiariosValoresDiariosAnaliticoAction extends GcomAction {
	/**
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		ActionForward retorno = actionMapping
				.findForward("exibirConsultarDadosDiariosValoresDiariosAnalitico");
		...
		if (filtro != null){
			...
			if (idPerfil != null && !idPerfil.equals("") && !idPerfil.equals("-1")){
				...
				httpServletRequest.setAttribute("nomePerfil", imovelPerfil.getDescricao());
			...
			if (idCategoria != null && !idCategoria.equals("") && !idCategoria.equals("-1")){
				...
				httpServletRequest.setAttribute("nomeCategoria", categoria.getDescricao());
