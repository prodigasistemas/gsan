...
public class EmissaoExtratoConsultarDebitoClienteAction extends GcomAction {
	
	public ActionForward execute(ActionMapping actionMapping,
			ActionForm actionForm, HttpServletRequest httpServletRequest,
			HttpServletResponse httpServletResponse) {
		
		ActionForward retorno = actionMapping.findForward("emissaoExtratoConsultarDebitoCliente");
		...
		String[] idsContas = consultarDebitoClienteActionForm.getContasSelecionadas();
		String[] idsDebitos = consultarDebitoClienteActionForm.getDebitosSelecionados();
		String[] idsCreditos = consultarDebitoClienteActionForm.getCreditosSelecionados();
		String[] idsGuias = consultarDebitoClienteActionForm.getGuiasSelecionadas();
	...
	private Object[] obterContasSelecionadas(String[] idsContas, HttpSession sessao) {
		...
		if (idsContas != null && !idsContas.equals("")) {
			...
			Collection colecaoContasSessao = (Collection) sessao.getAttribute("colecaoContaValores");
