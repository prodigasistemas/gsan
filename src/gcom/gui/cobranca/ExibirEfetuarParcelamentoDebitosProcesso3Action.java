...
public class ExibirEfetuarParcelamentoDebitosProcesso3Action extends GcomAction {
    ...
    public ActionForward execute(ActionMapping actionMapping,
        ...
        if (sessao.getAttribute("colecaoContaValores") != null) {
            ...
            valorCreditoARealizar = Util.formatarMoedaRealparaBigDecimal((String)  form.get("valorTotalCreditoARealizar"));
                ...
                if (colecaoCreditoARealizar != null && !colecaoCreditoARealizar.isEmpty() ) {
                    ...
                    while (creditoARealizarValores.hasNext()) {
                        ...
                        if (isCreditoDeParcelamento(creditoARealizar)) {
                            ...
                            valorCreditoARealizar = valorCreditoARealizar.add(valorTotalCreditosAnterioresCurtoPrazo);
                            ...
                            valorCreditoARealizar = valorCreditoARealizar.add(valorTotalCreditosAnterioresLongoPrazo);
