...
public class NegativadorContrato extends ObjetoTransacao implements Serializable {
	...
	private Short indicadorControleNsaRetorno;
	...
	public NegativadorContrato(Integer id, String numeroContrato, String codigoConvenio, Date dataContratoInicio, Date dataContratoFim,
			Date dataContratoEncerramento, String descricaoEmailEnvioArquivo, int numeroSequencialEnvio, int numeroSequencialRetorno, BigDecimal valorContrato,
			BigDecimal valorTarifaInclusao, Integer numeroInclusoesContratadas, Integer numeroInclusoesEnviadas, Integer numeroExclusoesEnviadas,
			int numeroTamanhoRegistroMovimento, short numeroPrazoInclusao, Date ultimaAlteracao, gcom.cobranca.Negativador negativador,
	...
	/** minimal constructor */
	public NegativadorContrato(Integer id, String numeroContrato, int numeroSequencialEnvio, int numeroSequencialRetorno, BigDecimal valorContrato,
			int numeroTamanhoRegistroMovimento, short numeroPrazoInclusao, Date ultimaAlteracao, gcom.cobranca.Negativador negativador,
			ContratoMotivoCancelamento contratoMotivoCancelamento) {
		this.id = id;
		this.numeroContrato = numeroContrato;
	...
	public Short getIndicadorControleNsaRetorno() {
		return indicadorControleNsaRetorno;
	}

	public void setIndicadorControleNsaRetorno(Short indicadorControleNsaRetorno) {
