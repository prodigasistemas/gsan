...
public class RelatorioComandoDocumentoCobrancaHelper implements Serializable {
	...
	public RelatorioComandoDocumentoCobrancaHelper(String numero, String nomeCliente, String endereco,
			String enderecoLinha2, String enderecoLinha3, String rotaGrupo, String matricula, String inscricao,
			String dataEmissao, String mesAno, String situacao, String executor, String dataCorte, String horaCorte,
			String numeroHidrometro, String leituraHidrometro, String localizacaoHidrometro, String dataVencimento,
			String valor, String representacaoNumericaCodBarraFormatada, String representacaoNumericaCodBarraSemDigito,
			String categoriaPrincipal, String situacaoLigacaoAgua, String situacaoLigacaoEsgoto, String codigoRota,
			String sequencialRota, String idDocumentoCobranca, String idFaturamentoGrupo) {
