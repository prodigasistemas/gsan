...
public class Funcionalidade extends TabelaAuxiliarAbreviada {
	...
	public static final int ENCERRAR_ATIVIDADE_ACAO_COBRANCA = 457;
	...
	public Funcionalidade(String descricao, String descricaoAbreviada, Date ultimaAlteracao, String caminhoMenu, String caminhoUrl, Short indicadorPontoEntrada, gcom.seguranca.acesso.Modulo modulo) {
	...
	@SuppressWarnings("rawtypes")
	public Funcionalidade(String descricao, String descricaoAbreviada, Date ultimaAlteracao, String caminhoMenu, String caminhoUrl, Short indicadorPontoEntrada, gcom.seguranca.acesso.Modulo modulo,
			Set funcionalidadeDependencias, Set funcionalidadeDependenciasByFncdIddependencia, Set operacoes) {
		this.descricao = descricao;
		this.descricaoAbreviada = descricaoAbreviada;
		this.ultimaAlteracao = ultimaAlteracao;
		this.caminhoMenu = caminhoMenu;
	...
	public void setFuncionalidadeCategoria(FuncionalidadeCategoria funcionalidadeCategoria) {
