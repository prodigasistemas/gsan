...
public class ServicoTipo extends ObjetoTransacao {
	...
	public final static int TIPO_INSTALACAO_RAMAL_COM_INST_HDT_CONTROLE_DE_PERDAS = 420;
	
	public final static int TIPO_SUBSTITUICAO_RAMAL_COM_SUBSTITUICAO_HDT_CONTROLE_DE_PERDAS = 421;
	
	public final static int TIPO_SUBSTITUICAO_RAMAL_SEM_INST_HDT_CONTROLE_DE_PERDAS = 422;
