...
public class RepositorioOrdemServicoHBM implements IRepositorioOrdemServico {
	...
	public List filtrarImovelEmissaoOrdensSeletivas(
		...
		try {
			...
			//Para Tipo de Servi�os que precisam de hist�rico de hidrometos. 
			...
			//Relaciona todos os tipo de servi�os que busquem imoveis com LigacaoAguaSituacao Ligada
		...
		//Buscar apenas imoveis com situa��o da liga��o factivel.		
		...
		//Buscar apenas imoveis com situa��o da liga��o cortada.	
		...
		//Buscar apenas imoveis com situa��o da liga��o suprimida.		
		if (helper.getTipoOrdem().equals("" + ServicoTipo.TIPO_REFORMA_RAMAL_COM_INST_HDT_CONTROLE_DE_PERDAS)
			...
			// Seleciona imoveis sem hist�rico de hidrometro.
			if (helper.getTipoOrdem().equals("" + ServicoTipo.TIPO_EFETUAR_INSTALACAO_HIDROMETRO) 
					|| (helper.getTipoOrdem().equals("" + ServicoTipo.TIPO_INSTALACAO_HIDROMETRO_CONTROLE_DE_PERDAS))
				...
				// Seleciona imoveis com hist�rico de hidrometro.	
