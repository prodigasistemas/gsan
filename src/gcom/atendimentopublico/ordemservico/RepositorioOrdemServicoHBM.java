...
public class RepositorioOrdemServicoHBM implements IRepositorioOrdemServico {
	...
	public OrdemServico recuperaOSPorId(Integer idOS)
		...
		try {
			...
			if (retornoConsulta != null) {
				...
				// Colocado por Sá¶©o Luiz em 12/09/2011
		...
		try {
			...
			if (retornoConsulta != null) {
				...
				if ((Integer) retornoConsulta[9] != null) {
					...
					// Alterado por Sá¶©o Luiz Data:12/09/2011
	...
	/**
	 * Pesquisa as equipes de acordo com os parï¿½metros informado pelo
	 * usuï¿½rio
	 * 
	...
	/**
	 * [UC0455] Exibir Calendï¿½rio para Elaboraï¿½ï¿½o ou Acompanhamento de
	 * Roteiro
	 * 
	 * @author Raphael Rossiter
	 * @date 14/02/2007
	...
	/**
	 * Verifica se jï¿½ existe Ordem de Servico de Instalacao/Substituicao de
	...
	public Collection pesquisarOrdemProcessoRepavimentacaoPorTipoPavimentoCalcada(
		...
		try {
			consulta = "select "
					...
					+ // 2 - descriï¿½ï¿½o do pavimento rua
					"sum(ospv.ospv_nnareapvtocal) as somatorioArea "
					+ // 3 - somatï¿½rio da metragem do pavimento de rua.
	...
	public Collection pesquisarOrdemProcessoRepavimentacaoPorTipoPavimentoRuaRet(
		...
		try {
			consulta = "select "
					...
					+ // 0 id do pavimento tipo
					"prua.prua_dspavimentorua as descricao,  "
					+ // 1 - descriï¿½ï¿½o do pavimento rua
					"sum(ospv.ospv_nnareapvtoruaret) as somatorioArea "
					+ // 2 - somatï¿½rio da metragem do pavimento de rua.
					" from atendimentopublico.ordem_servico_pavimento ospv "
					+ "left join  atendimentopublico.ordem_servico orse on  orse.orse_id = ospv.orse_id "
					+ "left join  atendimentopublico.servico_tipo svtp on  svtp.svtp_id = orse.svtp_id "
	...
	/**
	 * [UC1193] Consultar Comandos de OS Seletiva de Inspeï¿½ï¿½o de
	 * Anormalidade
	 * 
	 * @author Vivianne Sousa
	 * @since 11/07/2011
	...
	/**
	 * [UC1192] Movimentar OS Seletiva de Inspeï¿½ï¿½o de Anormalidade [FS0003]
	 * ï¿½ Verificar se imï¿½vel faz parte do comando
	 * 
	 * @author Vivianne Sousa
	 * @date 19/07/2011
	 */
	...
	public void excluirOSProgramadas(Integer idUnidadeOrganizacional,
		...
		try {
			...
			// pesquisa as ordens de serviç¯ dos arquivos que estã¯ com a
			// situaç£¯ de "LIBERADO"
	...
	/**
	 * -- [UC1190] Programaç£¯ Automá´©ca do Roteiro para Acompanhamento das OS
	 * 
	 * @author Sá¶©o Luiz
	 * @date 19/07/2011
	 */
	 ...
	 * 
	 * @param idEquipe
	 *            - id da equipe que terá ¡s os incluidas
	 * 
	 * @return Collection<OSProgramacao> - Coleç£¯ com todos as ordens de
	 *         servico a serem incluidas na programaç£¯
	 * 
	 * @throws ErroRepositorioException
	 */
	 ...
	 *            - Data para a pesquisa das OS
	 * 
	 * @return Collection<Integer> - Coleç£¯ com todos os ID's das equipes.
	 * 
	 * @throws ErroRepositorioException
	 */
	...
	/**
	 * [UC1227] Atualizar Ordens Serviç¯ de Acompanhamento de Celular
	 * 
	 * @autor Sá¶©o Luiz
	 * @date 22/09/2011
	 * 
