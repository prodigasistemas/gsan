			...
			while (colecaoContasIterator.hasNext()) {
				...
				if (pesquisaCliente != null && !pesquisaCliente.trim().equals("")) {
					...
					if (criarSubtotal) {
						...
						// Reinicializa as variáveis de totalização e o contador. Além disso, muda o imóvel valor do imóvel
						// anterior para o do atual para verificar se será necessário criar um subtotal.
						count = 1;
						idImovelAnterior = contaValoresHelper.getConta().getImovel().getId();
