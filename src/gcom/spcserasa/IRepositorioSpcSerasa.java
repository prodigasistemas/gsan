...
public interface IRepositorioSpcSerasa {
	...
	/**
	 * [UC0688] - Gerar Resumo Diario da Negativação [SB0006] Acompanhar
	...
	/**
	 * [UC0688] - Gerar Resumo Diario da Negativação menor PARC_ID da tabela
	...
	/**
	 * [UC0688] - Gerar Resumo Diario da Negativação pesquisa ocorrência na
	 ...
	 * (CNTA_ID=CNTA_ID da tabela CONTA com IMOV_ID=Id do Imóvel recebido e
	 * CNTA_AMREFERENCIACONTA=Referência recebida) E NMRG_ID=NMRG_ID da tabela
	 * NEGATIVADOR_MOVIMENTO_REG com IMOV_ID=Id do Imóvel recebido
	 * 
	 * @author Vivianne Sousa
	 * @data 10/09/2009
	 * 
	 ...
	 * pesquisa a partir da tabela NEGATIVADOR_MOVIMENTO_REG_ITEM com
	 * NMRI_ICSITDEFINITIVA=2 E CNTA_ID com o valor diferente de nulo E
	 * ((CNTA_ID=CNTA_ID da tabela CONTA_HISTORICO com IMOV_ID=Id do Imóvel
	 * recebido e CNHI_AMREFERENCIACONTA=Referência recebida) ) E
	 ...
	 * com Itens de Negativação 1.1. O sistema obtém dados da conta do pagamento
	...
	/**
	 * [UC0329] Restabelecer Situação Anterior de Conta [SB0002] - Atualizar
	 * Item da Negativação-Desfazer Retificação
	 * 
	 * @author Vivianne Sousa
	 * @date 21/09/2009
	 */
	...
	/**
	 * [UC0329] Restabelecer Situação Anterior de Conta [SB0001] - Atualizar
	 * Item da Negativação-Desfazer Cancelamento
	 * 
	 * @author Vivianne Sousa
	 * @date 21/09/2009
	 */
	 ...
	 * movimento reg que a situação de débito de cobrança da negativação
	 ...
	 * (existe ocorrência na tabela NEGATIVADOR_MOVIMENTO_REG_PARCELAMENTO com
	...
	/**
	 *
	 * Verificar ocorrência de movimento de exclusão incompleto [UC0688] Gerar
	 * Resumo Diário da Negativação
	 *
	 * @author Vivianne Sousa
	 * @date 10/02/2010
	 */
	...
	/**
	 * [UC0671] - Gerar Movimento de Inclusão de Negativação [SB0006] –
	...
	/**
	 * [UC0671] Gerar Movimento de Inclusao de Negativação [SB0006] Verificar
	 ...
	 * cobranca.NEGATIVADOR_MOVIMENTO com NGCM_ID=Id do Comando de Negativação
	 * recebido).
	 *
	 ...
	 * [UC0671] Gerar Movimento de Inclusão de Negativação
	 * 
	 * Quantidade de Imóveis em Reg (quantidade de linhas na tabela
	 * cobranca.NEGATD_MOVIMENTO_REG com NGMV_ID=NGMV_ID da tabela
	 * cobranca.NEGATIVADOR_MOVIMENTO com NGCM_ID=Id do Comando de Negativação
	 * recebido).
	 *
	 ...
	 * [UC0671] Gerar Movimento de Inclusão de Negativação
	 * 
	 * Quantidade de Imóveis em Negativação Imóveis (quantidade de linhas na
	 * tabela cobranca.NEGATIVAOCAO_IMOVEIS com NGCM_ID=Id do Comando de
	 * Negativação recebido).
	 *
	 * @author Raphael Rossiter
	 * @date 22/03/2011
	 *
	 ...
	 * [UC0671] Gerar Movimento de Inclusão de Negativação
	 * 
	 * Quantidade de Imóveis em Situção de Cobrança (quantidade de linhas na
	 * tabela cadastro.IMOVEL_COBRANCA_SITUACAO com ISCB_DTRETIRADACOBRANCA com
	 * o valor nulo e CBST_ID=16 ou 17 (“Em Análise para Negativação”) e
	 * IMOV_ID=IMOV_ID da tabela cobranca.NEGATIVAOCAO_IMOVEIS com NGCM_ID=Id do
	 * Comando de Negativação recebido).
	 *
	 * @author Raphael Rossiter
	 * @date 22/03/2011
	 *
	...
	/**
	 * [UC1005] - Determinar Confirmação da Negativação [SB0002] – Atualizar
	 * Data da Retirada da Situação Carta Enviada
	 * 
