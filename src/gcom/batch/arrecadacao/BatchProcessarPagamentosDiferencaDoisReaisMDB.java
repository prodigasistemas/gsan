...
public class BatchProcessarPagamentosDiferencaDoisReaisMDB implements MessageDrivenBean, MessageListener {

	private static final long serialVersionUID = 1L;

	public BatchProcessarPagamentosDiferencaDoisReaisMDB() {
		super();
	}
	...
	public void onMessage(Message message) {
		if (message instanceof ObjectMessage) {
			...
			try {
				this.getControladorArrecadacao().processarPagamentosDiferencaDoisReais(
