...
//				debitosCobrados.addAll(debitosCobradosHistorico);
	...
	public FichaCompensacaoDTO registrarBoletoBB(Integer idConta) throws ControladorException {
		...
		try {
			...
			//verifica��o para se tivermos mais de um codigo convenio no futuro
		/*	if(imovel.getCodigoConvenio().equals(3128557)) {
			...
			Integer numeroCarteira = ?; // Em produ��o, informar o n�mero da carteira de cobran�a.
			Integer numeroVariacaoCarteira = ?; // Em produ��o, informar o n�mero da varia��o da carteira de cobran�a.
