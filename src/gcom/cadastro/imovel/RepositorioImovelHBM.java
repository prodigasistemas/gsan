...
//					+ " left join clienteImovel.cliente cliente ";
			...
			* autor: Adriana Muniz
			* data: 17/09/2012
			* tratamento de exce��o, caso seja exce��o devido a convers�o de alfanumerico para numerico */
			try {
...
//	}
	...
	throws ErroRepositorioException {
		 ...
		 * @autor: Adriana Muniz
		 * @date: 24/11/2011
		 * Acr�scimo de atributo esfera de poder na consulta
		 * */
		try {
...
//					+ "rota.rota_id as idRota "
					 ...
					 * @date 06/08/2013
					 * 
					 * Corre��o da nomenclatura do hidrometro_instalacao_historic (anterior hidrometro_instalacao_historico_esgoto) 
					 */
					+ "left join micromedicao.hidrometro_protecao as hidrometro_protecao_esgoto on hidrometro_instalacao_historic.hipr_id = hidrometro_protecao_esgoto.hipr_id ";
...
//				}
	...
	/**
	 * [UC0823] Atualizar Situa��o �gua Para Ligado Auhtor: Yara Taciane
	 * Data: 07/07/2008
	 * 
	 * @param id
	 *            Matricula do Imovel
	...
	/**
	 * Este m�todo est� de acordo com o [UC0979] Gerar Relat�rio de Im�veis em Programas Especiais.
	 * 
	...
	public Integer  pesquisarDebitoTipoImovelDoacao(
		...
		/**
		 * * Script HQL que j� monta uma cole��o de ImovelCobrarDoacaoHelper com
		 * tudo que � necess�rio **
		 */
		try {
	...
	/**
	 * Caso o retorno seja TRUE, quer dizer que a altera��o da inscri��o acarretou na mudan�a do grupo de faturamento,
	 * e este novo grupo do im�vel ja foi faturado.
	 * 
	 * 
	 * @author Arthur Carvalho
	 * @date 16/09/2010
	...
	public void retirarCobrancaImovelCobrancaPorEmpresa(Integer idImovel, Integer idCobrancaSituacao, Usuario usuario)
		...
		try {
			...
			session.createQuery(consulta.toString())
					...
					.setString("observacao", "FIM DO CICLO DE COBRAN�A POR EMPRESA.")
					.executeUpdate();
