...
//					.addScalar("consumoMedio", Hibernate.INTEGER)
	...
	/**
	 * O mï¿½todo abaixo realiza uma pesquisa em imovel e retorna os campos
	 * necessï¿½rios para a criaï¿½ï¿½o da inscriï¿½ï¿½o para exibiï¿½ï¿½o, independente do imï¿½vel
	 * ter sido excluï¿½do ou nï¿½o.
	 * 
	 * acima no controlador serï¿½ montada a inscriï¿½ï¿½o
	 */
...
//					+ " left join clienteImovel.cliente cliente ";
			...
			/**
			 * autor: Adriana Muniz data: 17/09/2012 tratamento de exceï¿½ï¿½o, caso seja
			 * exceï¿½ï¿½o devido a conversï¿½o de alfanumerico para numerico
			 */
			try {
...
//	}
	...
	public Collection pesquisarColecaoImovel(
		...
		/**
		 * @autor: Adriana Muniz
		 * @date: 24/11/2011 Acrï¿½scimo de atributo esfera de poder na consulta
		 */
		try {
...
//					+ "rota.rota_id as idRota "
					 ...
					 * @date 06/08/2013
					 * 
					 *       Correï¿½ï¿½o da nomenclatura do hidrometro_instalacao_historic (anterior
...
//				}
	 ...
	 * ï¿½ a quem tem maior soma de qtd de economias em suas subcategorias e tenha o
	 ...
	 * [UC0688] Gerar Resumo Diï¿½rio da Negativaï¿½ï¿½o Fluxo principal Item 1.0
	 *
	 * @author Thiago Toscano
	 * @date 07/01/2008
	 */
	...
	/**
	 * [UC0823] Atualiza Ligaï¿½ï¿½o de ï¿½gua de Ligado em Anï¿½lise para Ligado Seleciona
	 * a lista de imï¿½veis que esteja com a situaï¿½ï¿½o de ï¿½gua ligado em anï¿½lise.
	 * 
	 * @author Yara Taciane
	 * @date 23/05/2008
	 */
	...
	/**
	 * [UC0823] Atualizar Situaï¿½ï¿½o ï¿½gua Para Ligado Auhtor: Yara Taciane Data:
	 * 07/07/2008
	 * 
	 * @param id                 Matricula do Imovel
	 * @param situacaoAguaLigado Situaï¿½ï¿½o Agua
	 * 
	...
	/**
	 * Este mï¿½todo estï¿½ de acordo com o [UC0979] Gerar Relatï¿½rio de Imï¿½veis em
	 * Programas Especiais.
	 * 
	 ...
	 * 
	 * Mï¿½todo criado para atualizar apenas os campos necessï¿½rios para imovel.
	 * 
	 * @author Bruno Barros
	 * @date 31/03/2010
	 * @param imovel
	...
	public Integer pesquisarDebitoTipoImovelDoacao(Integer idImovel) throws ErroRepositorioException {
		...
		/**
		 * * Script HQL que jï¿½ monta uma coleï¿½ï¿½o de ImovelCobrarDoacaoHelper com tudo
		 * que ï¿½ necessï¿½rio **
		 */
		try {
	...
	/**
	 * Caso o retorno seja TRUE, quer dizer que a alteraï¿½ï¿½o da inscriï¿½ï¿½o acarretou
	 * na mudanï¿½a do grupo de faturamento, e este novo grupo do imï¿½vel ja foi
	 * faturado.
	 * 
	 * 
	 * @author Arthur Carvalho
	 ...
	 * imï¿½vel - Gerar Arquivo da declaraï¿½ï¿½o de quitaï¿½ï¿½o anual de dï¿½bito
	 */
...
//		parameters.put("refereciaFinal", Util.gerarDataApartirAnoMesRefencia(refereciaFinal));
	...
	public void retirarCobrancaImovelCobrancaPorEmpresa(Integer idImovel, Integer idCobrancaSituacao, Usuario usuario)
		...
		try {
			...
			session.createQuery(consulta.toString()).setTimestamp("ultimaAlteracao", new Date())
					...
					.setString("observacao", "FIM DO CICLO DE COBRANï¿½A POR EMPRESA.").executeUpdate();
	...
	/**
	 * [UC0000] Obter Consumo Nï¿½o Medido por Parï¿½metro [FS0001] - Verificar "Pontos
	 * de Utilizaï¿½ï¿½o" Nï¿½o Informado.
	 * 
	 * @author Mariana Victor
	 * @date 23/05/2011
	 * 
	...
	/**
	 * [UC0000] Obter Consumo Nï¿½o Medido por Parï¿½metro [FS0002] - Verificar ï¿½Nï¿½mero
	 * de Moradoresï¿½ Nï¿½o Informado.
	 * 
	 * @author Mariana Victor
	 * @date 23/05/2011
	 * 
