...
public class ServicoSMS {
	...
	public static String MSG_CONFICMACAO_CADASTRO_PORTAL = "MSG_CONFICMACAO_CADASTRO_PORTAL";
		...
		try {
			...
			str.append("[")
			   .append("{")
				...
				.append("\"msg\" : " + "Caro cliente. Recebemos seu cadastro no Portal da COSANPA. Assim que aprovado, entraremos em contato. Muito obriado!")
				.append("}")
				.append("]");
