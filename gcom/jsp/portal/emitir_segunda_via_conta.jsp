		...
		<div class="container pagina">
			...
			<div class="pagina-conteudo">
				...
				<table class="table table-bordered text-center">
					<thead>
						<tr>
							<th style="width:33.33%"><span>Data: </span>${EmitirSegundaViaContaActionForm.data}</th>
							<th style="width:33.33%"><span>Total de Faturas em Aberto: </span>R$ ${EmitirSegundaViaContaActionForm.valorDebito}</th>
							<th style="width:33.33%"><span>Total de Débitos: </span>R$ ${EmitirSegundaViaContaActionForm.valorDebitoCobrado}</th>
						</tr>
					</thead>
				</table>
