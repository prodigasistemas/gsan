...
<html:form action="/exibirConsultarDadosDiariosValoresDiariosComTarifaAction.do"
		...
		<tr>
			...
			<table width="100%" border="0">
				<tr>
					...
					<table width="100%" border="0">
					<% if((idArrecadador != null && !idArrecadador.equals("")) && idArrecadacaoForma == null) {
							%>
						<tr bgcolor="#cbe5fe">
						<td align="right" width="100%">
								<strong>
									<a href="javascript:abrirPopup('exibirConsultarDadosDiariosValoresDiariosAnaliticoComTarifaAction.do?referencia=<%= referencia%>&idArrecadadorPopup=${requestScope.idArrecadadorPopup}', 475, 800);">
										Por Forma de Arrecadação com Tarifa
									</a>
								</strong>
						</td>
						</tr>
